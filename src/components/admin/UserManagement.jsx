        ...
        <div className="p-6  rounded-lg mb-6">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <button type='submit' className='bg-green-500 py-2 px-4 rounded hover:bg-green-600 font-bold'>
                    Create User
                  </button>
            </form>
        </div>
                ...
                <tbody>
                    {users.map((user)=>(
                        <tr key={user._id} className='border-b hover:bg-gray-50'>
                            ...
                            <td className="p-4">
                                <button onClick={()=>handleDeleteUser(user._id)} className='bg-red-500 text-white px-4py2
                                 rounded hover:bg-red-600 p-1'>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
