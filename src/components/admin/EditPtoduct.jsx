        ...
        <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-6">
                    ...
                    <input required type="text" name="name" value={productData.name} onChange={handleChange} className='w-full border p-2 rounded-md border-gray-300'/>
                </div>

                <div className="mb-6">
                    <label className='block font-semibold mb-2'> Description</label>
                    <textarea name="description" value={productData.description} className='w-full border border-gray-300 rounded-md p-2' rows={3} required onChange={handleChange}></textarea>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className='flex gap-4 mt-4'>
                        {productData.images.map((image,ind)=>(
                            <img src={image.url} key={ind} alt={image.altText || "Product Image"} className='w-20 h-20 object-cover rounded-md shadow-md'/>
                        ))}
                    </div>
                </div>
