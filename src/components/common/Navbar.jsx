  ...
  return (
   ...
   <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
       ...
       <div className='flex items-center space-x-4'>
        <Link to="/admin" className='block rounded text-sm bg-black text-white px-2 py-1'>Admin</Link>
    ...
    <div className={`fixed top-0 w-3/4 left-0 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen? "translate-x-0":"-translate-x-full"}`}>
      <div className='flex justify-end p-4'>
        <button onClick={toggleNavDrawer}><IoMdClose className='h-6 w-6 text-gray-600'/></button>
      </div>
      <div className='p-4'>
