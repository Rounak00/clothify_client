      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-8">
        <div>
          ...
          <form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              handleSubscription(email); // email will be from useState
            }}
          >
            <input
              type="email"
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li>
              <Link to="/collections/all?category=Top+Wear&gender=Men&size=&material=&brand=&maxPrice=10000" className="hover:text-gray-500 transition-colors">
                Men's Top Wear
              </Link>
            </li>
            <li>
