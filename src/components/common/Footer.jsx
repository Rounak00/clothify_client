            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-4 mb-6">
                        <a href='https://www.facebook.com' target='_blank' rel="noopener moreferrer" className='hover:text-gray-300'>
                         <TbBrandMeta className='h-5 w-5'/>
                        </a>
                        <a href='https://www.instagram.com' target='_blank' rel="noopener moreferrer" className='hover:text-gray-300'>
                            <IoLogoInstagram className='h-5 w-5' />
                        </a>
                        <a href='https://www.x.com' target='_blank' rel="noopener moreferrer" className='hover:text-gray-300'>
