    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto flex flex-col md:flex-row gap-8'>
            <div className='relative flex-1'>
                <img src={womenImg} alt="Womens collections" className='w-full h-[700px] object-cover'/>
                <div className='absolute bottom-3 left-8 bg-white opacity-90 p-4'>
              ...
              <div className='relative flex-1'>
                  <img src={menImg} alt="Mens collections" className='w-full h-[700px] object-cover' />
                  <div className='absolute bottom-3 left-8 bg-white opacity-90 p-4'>
                      <h2 className='text-2xl font-bold text-gray-900 mb-3'>
                          Men's Collection
                      </h2>
